...
public class Wave extends View{
    ...
    private int mBroderWidth=6;
    private int mBroderColor=Color.parseColor("#28FFFFFF");
    ...
    private int contentColor=Color.parseColor("#3F51B5");
    private int contentsize=41;
    ...
    private void init() {
        ...
        mBorderPaint.setColor(mBroderColor);
        mBorderPaint.setStrokeWidth(mBroderWidth);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowWave && mWaveShader != null) {
            ...
            // this decides the start_car position(mWaveShiftRatio for x, mWaterLevelRatio for y) of waves
            ...
            canvas.drawText(contentText,width/2,height/2,mTextPaint);
    ...
    private void initAnimation() {
        ...
        ObjectAnimator waterLevelAnim = ObjectAnimator.ofFloat(
                this, "waterLevelRatio", 0f, waveHeight);
        ...
        ObjectAnimator amplitudeAnim = ObjectAnimator.ofFloat(
                this, "amplitudeRatio", 0.001f, 0.05f);
